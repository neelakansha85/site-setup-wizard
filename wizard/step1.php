                ...
                foreach ( $site_type as $site_type_user => $site_type_user_details ) {
                    if ( $is_user_role_restriction != true ) {
                        foreach ( $site_type_user_details as $site_type_user_details_key => $site_type_user_details_value ) {
                            ?>
                            <input name="ssw_start_<?php _e($site_type_user_details_key); ?>" class="ssw-start-btn" type="button" onclick="ssw_js_submit_first_step('<?php _e($site_type_user_details_key); ?>')" value="<?php _e($site_type_user_details_value); ?>" />
                            <?php
                        }
                    }
                    else {
